...
// 1. Define the "Shape" of our country data to satisfy TypeScript
...
export default function Dashboard() {
  ...
  // 2. Cast the values to our CountryData type so TypeScript sees the 'name' property
  ...
  return (
    <div style={{ marginLeft: '220px', padding: '30px', backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'sans-serif', color: '#002B56' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px', marginBottom: '15px' }}>
        ...
        <Card title="Activation Rate" value={`${activationRate.toFixed(1)}%`} subText={healthStatus.text} valueColor={activationRate < 80 ? '#ef4444' : '#059669'} />
        <Card title="Current Graduates" value={totals.graduated.toLocaleString()} />
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px', marginBottom: '25px' }}>
        <Card title="Projected Graduation" value={projectedGrads.toLocaleString()} subText="At 50% target Grad rate" />
